...
use fingerprint::{FindingFingerprintInput, fingerprint, fingerprint_finding};
use normalize::{
    DiagnosticText, normalize_diagnostic, normalize_message, normalize_message_and_context,
};
